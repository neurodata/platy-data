...
[![Jupyter Book Badge](https://jupyterbook.org/badge.svg)](http://docs.neurodata.io/platy-data/)
...
- Navigate to a directory where you want to store the project, and clone this repo: 
   ```
   git clone https://github.com/neurodata/platy-data
   ```
...
- Create a Poetry environment:
  ...
  - For me, the output looks like
     ```
    Creating virtualenv platy-data in /Users/bpedigo/bilateral-test/platy-data/.venv
    Using virtualenv: /Users/bpedigo/bilateral-test/platy-data/.venv
    ```
...
- Now you should be able to run any individual python files like normal, for example: 
  ```
  python ./platy-data/scripts/er_unmatched_test.py
  ```
- Instead of running as a Python file, you can also easily convert a Python file to a
  ...
  ```
  sh ./platy-data/shell/make_notebook er_unmatched_test
  ```
...
- To build the documentation, do:
  ```
  jb build ./platy-data/docs
  ```
- You can then view the locally built HTML by pasting the produced link into your
  browser. For me, the built index is stored at `./platy-data/docs/_build/html/index.html`


## Questions about the code or paper 
Please get in touch! You are welcome to [make an issue](https://github.com/neurodata/platy-data/issues/new)
or email me at kullah2@jhu.edu.