...
"""
print(gen_right_adj())
print(gen_right_normal_lcc_adj())

print(gen_head_adj())
print(gen_head_normal_lcc_adj())

print(gen_pygidium_adj())
print(gen_pygidium_normal_lcc_adj())

print(gen_1_adj())
print(gen_1_normal_lcc_adj())

print(gen_2_adj())
print(gen_2_normal_lcc_adj())

print(gen_3_adj())
print(gen_3_normal_lcc_adj())
